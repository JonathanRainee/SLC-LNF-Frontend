    ...
    <div className='justify-center items-center h-screen'>
      <div className="max-w-lg mx-auto pt-8 rounded-lg">
        <form>
          ...
          <button onClick={insertItem} type="submit" className="w-full btn btn-outline btn-info  text-blck py-2 my-2 rounded-md hover:bg-t-blue focus:outline-none bg-s-blue">
            Insert Item
          </button>
        </form>
      </div>
